...
The main time display is inspired by Din Time, a watchface no longer maintained. The digits used for the hour are the same as those used on German road signs, ensuring excellent readability even from a distance.
...
**Quick reference:**
- ![Cactus](docs/images/cactus_icon.png)![Cactus](docs/images/cactus_icon.png)![Cactus](docs/images/cactus_icon.png) **3 cacti** = Humidity below 20% (desert-like conditions)
- ![Cactus](docs/images/cactus_icon.png)![Cactus](docs/images/cactus_icon.png) **2 cacti** = Humidity between 21% and 30%
- ![Cactus](docs/images/cactus_icon.png) **1 cactus** = Humidity between 31% and 40%
- ![Leaf](docs/images/leaf_icon.png) **Leaf** = Comfortable humidity (40%-60%)
- ![Drop](docs/images/humidity_icon.png) **1-3 water drops** = Increasing humidity above 60%
...
**Link:** [Pebble App Store - Din Clean](https://apps.rebble.io/applications/63555cd1b9710000096ea5f8)
...
**[Release] Din Clean v2.0 - Weather Watchface with 12h Forecast Graph & No API Key Needed**

Hey Pebble community!

I'm excited to share the latest update to my watchface **Din Clean** — a minimalist black & white watchface packed with comprehensive weather data.

## What makes it special?

**Maximum Readability** — Pure black & white design. No fancy colors, just clean contrast that works in any lighting. The time display is inspired by the classic **Din Time** watchface, which is no longer maintained.

**12-Hour Forecast Graph** — Tap to reveal:
- Temperature curve
- Precipitation bars (full bar = 40mm rain)
- Wind speed per slot
- 3-day forecast with icons

**Smart Humidity Indicators:**
- 1-3 water drops = 60%+ humidity
- Leaf icon = comfort zone (40-60%)
- 1-3 cactus icons = dry conditions (below 40%)
  - 2 cacti = 21-30% humidity
  - 3 cacti = below 20% (very dry!)

**Wind at a Glance** — Corners around the weather icon light up based on wind speed:
- 1 corner = light breeze (>5 km/h or >11 mph)
- 2 corners = moderate wind (>10 km/h or >22 mph)
- 3 corners = fresh wind (>15 km/h or >33 mph)
- 4 corners = strong wind (>20 km/h or >44 mph)

**NO API KEY NEEDED** — Uses MET Norway API (free, accurate, worldwide coverage). Just install and go!

**IOPool Integration** — Pool owners get automatic visual alerts when water parameters are out of range (ORP < 650 or pH < 7.10).
...
|-----------|---------|
| 3 cacti | Humidity ≤20% |
| 2 cacti | Humidity 21-30% |
| 1 cactus | Humidity 31-40% |
| Leaf | Comfort (40-60%) |
| 1 drop | Humidity 60-69% |
| 2 drops | Humidity 70-79% |
| 3 drops | Humidity 80%+ |
| Full rain bar | 40mm precipitation |
| 4 lit corners | >20 km/h (or >44 mph) |

## Compatibility
Pebble Classic | Pebble Time | Pebble 2


Let me know what you think! Bug reports and feature suggestions are always welcome.

---

If you REALLY like this app, you can give me a little something on [Paypal here](https://paypal.me/ChrJeannette).
